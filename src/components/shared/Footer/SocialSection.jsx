...
const socialLinks = [
    { href: 'https://t.me/yourchannel', icon: Send, label: 'تيليجرام' },
    {
            ...
            <ul className="space-y-3">
                {socialLinks.map(social => (
                    <li key={social.label}>
                        ...
                        >
                            <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-sky-400 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
