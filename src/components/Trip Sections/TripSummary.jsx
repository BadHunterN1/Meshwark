    ...
    <div  className="p-4 md:p-6 space-y-4">
        <div className="bg-white rounded-xl shadow-sm p-4 space-y-4">
            <div className="flex justify-between items-start flex-wrap gap-3">
                ...
                <button className="text-sm text-gray-600 border px-3 py-2 rounded-md hover:bg-gray-100 flex items-center justify-center gap-1 w-full lg:w-auto">
        ...
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-lg p-3 flex gap-4 items-center text-sm">
