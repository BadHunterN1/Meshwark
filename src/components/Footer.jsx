import { Send, Instagram, Facebook, Phone, MapPin, Mail } from "lucide-react";
		...
		<footer className="bg-[#2c3e50] text-white px-6 py-10">
			<div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
				<div className="pr-4 md:pr-6">
					<h3 className="text-xl font-semibold mb-3 text-[var(--main-color)]">
						مواصلات المنصورة
					</h3>
					<p className="text-sm text-gray-300 mb-2">
						تطبيق آمن لكل اللي بيستخدمه، بيساعدك في الوصول لأقرب خط مواصلات في
						المنصورة بكل سهولة مع معلومات دقيقة ومحدثة
					</p>
				...
				<div className="pl-4 md:pl-6">
					...
					<div className="mt-6">
						<h5 className="mb-3 text-sm text-right">
							اشترك في النشرة الإخبارية
						</h5>
						<div className="flex rounded-lg overflow-hidden bg-[#34495E] max-w-xs">
							<div className="bg-[var(--main-color)] p-3 flex items-center justify-center">
			...
			<div className="border-t border-gray-600 mt-10 pt-4 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center gap-2 px-4 md:px-10">
				<p className="md:order-1 text-center md:text-right">
					جميع الحقوق محفوظة لمشوارك 2025 ©
				</p>
				<p className="md:order-2 text-center md:text-left">
