import { Eye, Heart, MapPin, Trash2 } from 'lucide-react';
...
function FavouritesCards() {
  return (
    <div className="text-center px-6 py-12">
      ...
      <div className="relative bg-white rounded-2xl hover:shadow-lg hover:scale-[1.02] transition-all duration-300 flex flex-col md:flex-row gap-6 p-8 mb-8 max-w-5xl mx-auto text-right">
        <Heart
          size={28}
