...
export default function AboutApp() {
    const values = [
        ...
        },
        {
            title: 'التطوير',
            description:
                'نعمل باستمرار على تطوير خدماتنا وتحسين تجربة المستخدمين',
                        ...
                        <div className="max-w-4xl w-full bg-white shadow-md rounded-xl p-4 md:p-8 flex flex-col-reverse md:flex-row-reverse items-center justify-between gap-4 md:gap-8">
                            <div className="text-center md:text-right md:flex-1">
                                <p className="text-gray-700 md:text-lg leading-loose">
                                    نتطلع إلى أن نكون الرائدين في مجال النقل
                                    الذكي والمستدام، حيث نوفر حلولًا مبتكرة تسهل
                                    حياة الناس وتربط المجتمعات ببعضها البعض.
                                    نسعى لبناء مستقبل أفضل من خلال التكنولوجيا
                                    والخدمات المتطورة التي تلبي احتياجات عصرنا
                                    الحديث.
                                </p>
                            </div>
                ...
                <div className="container">
                    <MotionFadeIn>
                        ...
                        <p className="text-gray-600 text-lg mb-12">
                            المبادئ التي نؤمن بها ونسير عليها في رحلتنا نحو
                            التميز
                        </p>
                    </MotionFadeIn>
