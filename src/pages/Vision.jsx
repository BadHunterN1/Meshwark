...
export default function Vision() {
  const values = [
    {
      title: "التميّز",
      description: "نسعى لتقديم أفضل الخدمات وتحقيق معايير الجودة العالية في كل ما نقوم به",
      icon: <Star className="w-10 h-10 text-white" />,
    },
    {
      title: "الإبداع",
      description: "نؤمن بقوة الأفكار المبتكرة والحلول الإبداعية لمواجهة التحديات",
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-tr from-blue-100 to-green-100 px-4 py-16">
        <h2 className="text-6xl text-blue-400 font-bold mb-20 mt-4">رؤيتنا</h2>

        <div className="max-w-4xl w-full bg-white shadow-md rounded-xl p-8 flex flex-col-reverse md:flex-row-reverse items-center justify-between gap-8">
          <div className="text-center md:text-right md:flex-1">
            <p className="text-gray-700 text-lg leading-loose">
              نتطلع إلى أن نكون الرائدين في مجال النقل الذكي والمستدام، حيث نوفر حلولًا مبتكرة تسهل حياة الناس وتربط المجتمعات ببعضها البعض.
              نسعى لبناء مستقبل أفضل من خلال التكنولوجيا والخدمات المتطورة التي تلبي احتياجات عصرنا الحديث.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-tr from-blue-50 to-green-50 py-20 px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-blue-400 mb-4">قيمنا الأساسية</h2>
...
>
  ...
  <h3 className="text-xl font-bold text-blue-400 mb-2">{value.title}</h3>
  <p className="text-gray-600">{value.description}</p>
      ...
      <div className="py-20 px-4 flex flex-col items-center justify-start bg-gradient-to-tr from-blue-100 to-green-100">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-blue-400 mb-4">انضم إلينا في رحلة التميز</h2>
        <p className="text-gray-600 text-lg mb-12">
            كن جزءاً من مستقبل النقل الذكي واستمتع بتجربة فريدة تجمع بين الابتكار والجودة
        </p>
      </div>
    </>
  );
